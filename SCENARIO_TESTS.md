# Plausible Scenario Tests (PST) — Tally Connector
...
- `connect_tally`: validated contract & error handling
- `list_connections`: validated contract & error handling
- `disconnect_tally`: validated contract & error handling
- `list_forms`: validated contract & error handling
- `get_form`: validated contract & error handling
- `list_submissions`: validated contract & error handling
- `audit_survey_health`: validated contract & error handling
